...
enum KeySoundStyle: String, CaseIterable, Identifiable, Sendable {
    ...
    var title: String {
        switch self {
        case .novelKeysCream: L10n.text("奶油轴")
        case .holyPanda: L10n.text("圣熊猫轴")
        case .alpaca: L10n.text("羊驼轴")
        case .turquoiseTealios: L10n.text("绿松石轴")
        case .gateronBlackInk: L10n.text("佳达隆黑墨水轴")
        case .gateronRedInk: L10n.text("佳达隆红墨水轴")
        case .cherryMXBlack: L10n.text("樱桃黑轴")
        case .cherryMXBrown: L10n.text("樱桃茶轴")
        case .cherryMXBlue: L10n.text("樱桃青轴")
        case .kailhBoxNavy: L10n.text("凯华海军蓝轴")
        case .bucklingSpring: L10n.text("屈曲弹簧")
        case .skcmBlueAlps: L10n.text("阿尔卑斯蓝轴")
        case .topre: L10n.text("东普雷静电容")
        case .pianoImprovisation: L10n.text("钢琴 · 即兴演奏")
        case .pianoKeyboard: L10n.text("钢琴 · 键盘演奏")
        case .pianoMelody: L10n.text("钢琴 · 自动旋律")
        }
    }
    ...
    var detail: String {
        switch self {
        case .novelKeysCream: L10n.text("线性轴体的顺滑、饱满录音采样。")
        case .holyPanda: L10n.text("突出段落反馈的厚实录音采样。")
        case .alpaca: L10n.text("轻柔、干净的线性轴录音采样。")
        case .turquoiseTealios: L10n.text("清亮顺滑的线性轴录音采样。")
        case .gateronBlackInk: L10n.text("低沉、扎实的线性轴录音采样。")
        case .gateronRedInk: L10n.text("轻快、清晰的线性轴录音采样。")
        case .cherryMXBlack: L10n.text("沉稳的 Cherry 线性轴录音采样。")
        case .cherryMXBrown: L10n.text("带适度段落感的 Cherry 轴录音采样。")
        case .cherryMXBlue: L10n.text("清脆鲜明的 Cherry 点击轴录音采样。")
        case .kailhBoxNavy: L10n.text("反馈强烈的 BOX 点击轴录音采样。")
        case .bucklingSpring: L10n.text("经典屈曲弹簧键盘的响亮录音采样。")
        case .skcmBlueAlps: L10n.text("复古 Alps 点击轴的清脆录音采样。")
        case .topre: L10n.text("柔和而深沉的静电容键盘录音采样。")
        case .pianoImprovisation: L10n.text("按使用频率编排五声音阶，正常打字也能形成旋律。")
        case .pianoKeyboard: L10n.text("使用常见虚拟钢琴布局，可按键位主动演奏半音阶。")
        case .pianoMelody: L10n.text("每次按键推进一段预设旋律，无需记住任何琴键。")
        }
    }
    ...
    var usageHint: String? {
        switch self {
        case .pianoKeyboard:
            L10n.text("低音区：Z S X D C V G B H N J M　高音区：Q 2 W 3 E R 5 T 6 Y 7 U I")
        case .pianoMelody:
            L10n.text("任意按键都会推进旋律；输入速度决定节奏。")
        default:
            nil
        }
    }
